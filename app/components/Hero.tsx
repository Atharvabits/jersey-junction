    ...
    <section className="mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8">
      <div className="mb-8 flex flex-wrap justify-between md:mb-16">
        <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
          <h1 className="mb-4 text-2xl font-bold text-black sm:text-4xl md:text-5xl lg:text-6xl md:mb-8">
        ...
        <div className="mb-12 flex w-full md:mb-16 lg:w-2/3">
          <div className="relative left-6 top-6 sm:left-12 sm:top-12 z-10 -ml-6 sm:-ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-16 lg:ml-0">
            <Image
              ...
              className="h-48 w-48 sm:h-64 sm:w-64 md:h-full md:w-full object-cover object-center"
              width={400}
              height={400}
              priority
            />
      ...
      <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex justify-center w-full md:w-auto">
          <Link
            href="/all"
            className="w-full sm:w-auto flex items-center justify-center px-6 sm:px-8 py-3 text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200 rounded-lg border text-sm sm:text-base"
          >
            Shop All Products
          </Link>
        </div>
